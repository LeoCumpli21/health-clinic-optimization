...
from src.external_systems.exponential_dist_scipy import ExponentialDistributionScipy
...
def test_fit_estimates_params_without_fixed_loc(
...
def test_fit_uses_fixed_loc_and_estimates_scale(
    exponential_distribution_scipy_instance,
):
    """
